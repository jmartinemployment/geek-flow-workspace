...
const jsonValue: z.ZodType<Prisma.InputJsonValue> = z.lazy(() =>
  z.union([z.string(), z.number(), z.boolean(), z.record(jsonValue), z.array(jsonValue)]),
);
  ...
  try {
    ...
    const clone = await prisma.flow.create({
      data: {
        ...
        trigger: original.trigger as Prisma.InputJsonValue,
        connections: original.connections as Prisma.InputJsonValue,
        canvasLayout: original.canvasLayout as Prisma.InputJsonValue ?? undefined,
